...
hugo --contentDir collections/quiznights --config collections.toml,collections/quiznights/quiznightsocations.toml --destination /var/www/collections/quiznights