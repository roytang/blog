...
#TWITTER_SOURCE_FILE = "D:\\temp\\tweets.json"
...
def fb():
    ...
    data = [6, 18, 499, 264, 133, 202, 515, 1026, 1042, 2225, 1444, 1081, 315, 32, 0, 0, 0]
    data2 = [0, 0, 1, 11, 44, 46, 12, 596, 701, 2066, 765, 487, 138, 322, 0, 2, 0]
...
def reddit():
    ...
    submissions = [25,52,58,63,48,31,75,20,32,20,6,6,3,7]
    comments = [43,124,256,457,136,33,829,199,148,172,31,388,73,45]
    gen_chart(years, submissions, "reddit", title="Submissions", extra_data=[{"data": comments, "title": "Comments"}])    

def insta():

    years = ["2014","2015","2016","2017","2018","2019", "2020", "2021", "2022", "2023"]
    data = [6,69,389,115,21,108,46,26,41,2]
