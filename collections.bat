...
hugo --contentDir collections/quotes --config collections.toml,collections/quotes/quotes.toml --destination public/quotes
hugo --contentDir collections/comics --config collections.toml,collections/comics/comics.toml --destination public/comics
hugo --contentDir collections/galleries --config collections.toml,collections/galleries/galleries.toml --destination public/galleries
