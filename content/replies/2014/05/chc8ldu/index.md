...
reply_to:
  label: a comment by Wizards_Alison on '"if everything goes as expected, we plan
    ...
    July, prior to Magic Online's Magic 2015 Core Set release."' on /r/magicTCG
  name: ''
  type: reddit
  url: https://reddit.com/r/magicTCG/comments/24xbxy/if_everything_goes_as_expected_we_plan_on/chbx3f2/
source: reddit
syndicated:
- type: reddit
  url: https://www.reddit.com/r/magicTCG/comments/24xbxy/if_everything_goes_as_expected_we_plan_on/chc8ldu/
tags:
- magicTCG
---
