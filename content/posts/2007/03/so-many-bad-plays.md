...
author: Roy
type: post
date: 2007-03-24T03:07:13+00:00
...
<table border="0" width="100%">
  ...
  <tr>
    <td colspan="3">
      <span style="font-size: xx-small;"><br /> Under Development<br /> </span><br /> Standard @ NG Galleria 24-Mar-2007
    </td>
  </tr>
  
  <tr>
    <td colspan="2" align="center">
      <strong><br /> Main Deck<br /> </strong><br /> 60 cards
    </td>
    
    <td align="center">
      <strong><br /> Sideboard<br /> </strong>
    </td>
  </tr>
  
  <tr>
    <td valign="top" width="33%" height="120">
      <ul>
        <li>
          4 <a>Breeding Pool<br /> </a>
        </li>
        <li>
          3 <a>Stomping Ground<br /> </a>
        </li>
        <li>
          1 <a>Steam Vents<br /> </a>
        </li>
        <li>
          2 <a>Mountain<br /> </a>
        </li>
        ...
        <li>
          1 <a>Skargg, the Rage Pits<br /> </a>
        </li>
      </ul>
      
      <hr class="decktotals" align="left" size="1" width="50%" />
      
      <p>
        <span class="decktotals">23 land</span>
      </p>
      ...
      <ul>
        ...
        <li>
          3 <a>Sulfur Elemental<br /> </a>
        </li>
        <li>
          3 <a>Giant Solifuge<br /> </a>
        </li>
        <li>
          4 <a>Fathom Seer<br /> </a>
        </li>
        <li>
          2 <a>Mystic Snake<br /> </a>
        </li>
        <li>
          2 <a>Vesuvan Shapeshifter<br /> </a>
        </li>
        <li>
          1 <a>Brine Elemental<br /> </a>
        </li>
      </ul>
      ...
      <p>
        <span class="decktotals">18 creatures<br /> </span></td> 
        ...
        <td valign="top" width="33%" height="120">
          <ul>
            ...
            <li>
              3 <a>Research // Development<br /> </a>
            </li>
            <li>
              3 <a>Search for Tomorrow<br /> </a>
            </li>
            <li>
              4 <a>Farseek<br /> </a>
            </li>
            <li>
              3 <a>Think Twice<br /> </a>
            </li>
            <li>
              4 <a>Remand<br /> </a>
            </li>
          ...
          <p>
            <span class="decktotals"><br /> 19 other spells<br /> </span></td> 
            
            <td valign="top" width="33%" height="120">
              <ul>
                <li>
                  3 <a>Krosan Grip<br /> </a>
                </li>
                <li>
