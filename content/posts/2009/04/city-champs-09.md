...
--></p> 
  ...
  <div class="decklist">
    <ul class="decklist_group">
      ...
      <li>
        2 <a href="http://magiccards.info/autocard.php?card=Exotic Orchard">Exotic Orchard</a>
      </li>
    </ul>
    ...
    <ul class="decklist_group">
      ...
      <li>
        1 <a href="http://magiccards.info/autocard.php?card=Wydwen, the Biting Gale">Wydwen, the Biting Gale</a>
      </li>
      <li>
...
Unfortunately, it was not my night to win a top 8 extended art [Mutavault][6] or even one of an undetermined number of [Bramblewood Paragon][7]s. This tournament report&#8217;s going to be short.
...
This weekend is the Alara Reborn prerelease, and the upcoming set seems ready to turn standard upside-down, and we have a lot of standard to look forward to: Regionals, Nationals grinders and PTQs for Berlin. Hopefully Alara Reborn brings us an even more fun metagame.
 ...
 [1]: http://magiccards.info/autocard.php?card=Exotic Orchard
 [2]: http://magiccards.info/autocard.php?card=Volcanic Fallout
 [3]: http://magiccards.info/autocard.php?card=Terror
 [4]: http://magiccards.info/autocard.php?card=Mistbind Clique
 [5]: http://magiccards.info/autocard.php?card=Reliquary Tower
 [6]: http://magiccards.info/autocard.php?card=Mutavault
 [7]: http://magiccards.info/autocard.php?card=Bramblewood Paragon
 [8]: http://magiccards.info/autocard.php?card=Fulminator Mage
 [9]: http://magiccards.info/autocard.php?card=Reflecting Pool