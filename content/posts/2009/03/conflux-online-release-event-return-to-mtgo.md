...
type: post
date: 2009-03-01T06:56:23+00:00
...
<div class="decklist_wrap">
  <p class="switcher">
    <a href="#" class="hide">Hide Decklist</a><a href="#" class="show">Show Decklist</a>
  </p>
  ...
  <div class="decklist">
    <ul class="decklist_group">
      ...
      <li>
        5 <a href="http://magiccards.info/autocard.php?card=Mountain">Mountain</a>
      </li>
      <li>
        3 <a href="http://magiccards.info/autocard.php?card=Forest">Forest</a>
      </li>
      <li>
        1 <a href="http://magiccards.info/autocard.php?card=Arcane Sanctum">Arcane Sanctum</a>
      </li>
      <li>
        1 <a href="http://magiccards.info/autocard.php?card=Rupture Spire">Rupture Spire</a>
      </li>
      <li>
        2 <a href="http://magiccards.info/autocard.php?card=Naya Panorama">Naya Panorama</a>
      </li>
    </ul>
    ...
    <ul class="decklist_group">
      ...
      <li>
        2 <a href="http://magiccards.info/autocard.php?card=Dragonsoul Knight">Dragonsoul Knight</a>
      </li>
      <li>
        1 <a href="http://magiccards.info/autocard.php?card=Knight of the Skyward Eye">Knight of the Skyward Eye</a>
      </li>
      <li>
        2 <a href="http://magiccards.info/autocard.php?card=Ridge Rannet">Ridge Rannet</a>
      </li>
      <li>
      ...
      <li>
        1 <a href="http://magiccards.info/autocard.php?card=Ember Weaver">Ember Weaver</a>
      </li>
      <li>
    ...
    <ul class="decklist_group">
      ...
      <li>
        2 <a href="http://magiccards.info/autocard.php?card=Volcanic Fallout">Volcanic Fallout</a>
      </li>
      <li>
        1 <a href="http://magiccards.info/autocard.php?card=Jund Charm">Jund Charm</a>
      </li>
      <li>
        1 <a href="http://magiccards.info/autocard.php?card=Fiery Fall">Fiery Fall</a>
      </li>
      <li>
    ...
    <ul class="decklist_group">
      ...
      <li>
        2 <a href="http://magiccards.info/autocard.php?card=Elder Mastery">Elder Mastery</a>
      </li>
      <li>
        1 <a href="http://magiccards.info/autocard.php?card=Cancel">Cancel</a>
      </li>
      <li>
        1 <a href="http://magiccards.info/autocard.php?card=Tar Fiend">Tar Fiend</a>
      </li>
      <li>
        2 <a href="http://magiccards.info/autocard.php?card=Onyx Goblet">Onyx Goblet</a>
      </li>
      <li>
      ...
      <li>
        1 <a href="http://magiccards.info/autocard.php?card=Ranger of Eos">Ranger of Eos</a>
      </li>
      <li>
      ...
      <li>
        1 <a href="http://magiccards.info/autocard.php?card=Mana Cylix">Mana Cylix</a>
      </li>
      <li>
        1 <a href="http://magiccards.info/autocard.php?card=Constricting Tendrils">Constricting Tendrils</a>
      </li>
      <li>
        2 <a href="http://magiccards.info/autocard.php?card=Soul's Might">Soul's Might</a>
      </li>
      <li>
        1 <a href="http://magiccards.info/autocard.php?card=Gustrider Exuberant">Gustrider Exuberant</a>
      </li>
      <li>
        1 <a href="http://magiccards.info/autocard.php?card=Blood Tyrant">Blood Tyrant</a>
      </li>
      <li>
      ...
      <li>
        1 <a href="http://magiccards.info/autocard.php?card=Manaforce Mace">Manaforce Mace</a>
      </li>
      <li>
        1 <a href="http://magiccards.info/autocard.php?card=Kederekt Parasite">Kederekt Parasite</a>
      </li>
      <li>
        1 <a href="http://magiccards.info/autocard.php?card=Cathartic Adept">Cathartic Adept</a>
      </li>
      <li>
        1 <a href="http://magiccards.info/autocard.php?card=Jhessian Infiltrator">Jhessian Infiltrator</a>
      </li>
      <li>
        1 <a href="http://magiccards.info/autocard.php?card=Vectis Silencers">Vectis Silencers</a>
      </li>
      <li>
        1 <a href="http://magiccards.info/autocard.php?card=Sedraxis Alchemist">Sedraxis Alchemist</a>
      </li>
      <li>
      ...
      <li>
        1 <a href="http://magiccards.info/autocard.php?card=Unsummon">Unsummon</a>
      </li>
      <li>
        1 <a href="http://magiccards.info/autocard.php?card=Metallurgeon">Metallurgeon</a>
      </li>
      <li>
        1 <a href="http://magiccards.info/autocard.php?card=Corrupted Roots">Corrupted Roots</a>
      </li>
      <li>
        1 <a href="http://magiccards.info/autocard.php?card=Dark Temper">Dark Temper</a>
      </li>
      <li>
...
Playing Limited now feels so different from playing Limited back when I wasn&#8217;t a serious tournament player; I now spot a lot more mistakes and see a lot more room for improvement in my game. Unlike constructed where there&#8217;s a lot less variation in the number of interactions, in Limited basically anything can happen so you need to learn to react to a lot more situations. Maybe I should focus more on Limited again (if only it weren&#8217;t so expensive!)
 ...
 [3]: http://magiccards.info/autocard.php?card=Rupture Spire
 [4]: http://magiccards.info/autocard.php?card=Arcane Sanctum
 [5]: http://magiccards.info/autocard.php?card=Knight of the Skyward Eye
 [6]: http://magiccards.info/autocard.php?card=Dark Temper
 [7]: http://magiccards.info/autocard.php?card=Shambling Remains
