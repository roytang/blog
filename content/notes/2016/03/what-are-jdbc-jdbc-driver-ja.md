...
The rest are packages in the JDBC API. There are basic tutorials on Oracle.com: <span class="qlink_container"><a class="external_link" data-qt-tooltip="oracle.com" href="https://docs.oracle.com/javase/tutorial/jdbc/basics/" onclick="return Q.openUrl(this, 20983010);" rel="noopener nofollow" target="_blank">Lesson: JDBC Basics</a></span>