...
<span class="ui_qtext_rendered_qtext"><p class="ui_qtext_para u-ltr u-text-align--start">Try turning your suggestions into questions, which suggests inviting input from others. Instead of "In my opinion, telling this to the client will not be received well.", try "Do you think the client will receive this well?"</p></span>