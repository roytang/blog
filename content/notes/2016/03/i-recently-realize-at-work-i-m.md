...
<span class="ui_qtext_rendered_qtext"><p class="ui_qtext_para u-ltr u-text-align--start">If you are finding it difficult to deal with the interruptions, I suggest taking it up with your manager. Perhaps you can ask that requests for updates should be scheduled at a regular time (so you can prepare), or done via a channel that doesn't interrupt you directly (like email)</p></span>