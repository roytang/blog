...
I only recently found out about Github pages, which allows you to serve static content out of a Github repository, with a `github.io` subdomain. You can also point a domain name to it if you want (I haven't tried that yet).
