...
<div id="_mcePaste">
  <ul>
    ...
    <li>
      3G: I have not yet used the 3g. According to <a href="http://twitter.com/Talk2Globe">@Talk2Globe</a>, the prepaid microsim will not work with an iPad (I won't be able to reload it I guess) and I have to use their unlimited data plan microsim (P999 a month). That's actually not so bad, but I think I'm going to check first with Smart whether their prepaid microsim can be used. <a href="http://twitter.com/smartCARES">@SmartCARES</a> has not yet replied
    </li>
    <li>
...
<div id="_mcePaste">
  <ul>
    ...
    <li>
      <strong>Facebook</strong>: The facebook app on the app store is for iphone only, so I have to do the 2x size thing. It doesn't look very good (and doesn't seem to rotate well)
    </li>
    <li>
      <strong>VLC</strong>: Supposedly the solution to the lack of supported video formats in iTunes, it is a bit immature. At first I tried loading a lot of files into it (gotta maximize the 64gb!) but then it wouldn't launch and would just crash back to desktop. It turns out it cannot handle MKV files very well, it worked when I only loaded AVIs
    </li>
    <li>
      <strong>Stanza</strong>: PDF and comic book reader. The reading mode is pretty good, but it looks like it's going to be unwieldy if managing a large collection
    </li>
    <li>
