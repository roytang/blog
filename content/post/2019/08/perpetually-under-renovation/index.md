...
4. Webmentions! I set up [webmention.io](https://webmention.io) and [brid.gy](https://brid.gy) so this site now accepts webmentions. Currently only Twitter webmentions are enabled on brid.gy (see the samples in the screenshots above).
