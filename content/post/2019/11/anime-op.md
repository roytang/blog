...
Kimi Ga Suki da to Sakebitai from Slam Dunk by Baad:

{{% youtube 7qLwmho_240 %}}

Hohoemi no Bakudan from Yu Yu Hakusho by Matsuko Mawatari:

{{% youtube IEjRBJChZMA %}}

1/3 no Junjou na Kanjou from Rurouni Kenshin by Siam Shade:

{{% youtube rzziisIJudY %}}

(RK in particular had a lot of tracks I liked, but let's limit it to one per series)

Chala Head Chala from Dragonball Z by Hironobu Kageyama:

{{% youtube pYnLO7MVKno %}}

We Are! from One Piece by Hiroshi Kitadani:

{{% youtube ZwXKz2CeHwY %}}

That's all for now! Here's a [spotify playlist](https://open.spotify.com/playlist/1aUsKTSASpG2jPSDSzVICw) if you're into that sort of thing.