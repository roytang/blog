...
I've tagged this entry as ["decadenotes"](/blog/tags/decadenotes), which is a bit of hopeful optimism that this blog will still be around in more or less the same form 10 years from now. I don't know what the coming decade will bring, but I do know that the likelihood is that I only get maybe 2-4 more of these, optimistically, so here's to hopeful optimism about the decade(s) to come.