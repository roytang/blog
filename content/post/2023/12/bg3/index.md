...
- Inventory management was a challenge, which is typical of games of this size and scale. Maybe a bit better than it was in Divinity: OS2 though. You just tend to accumulate so much stuff and never use them. Majority of potions, special arrows, spell scrolls and such fall into this category, though maybe if I were playing on a harder difficulty level I would use them more. But just managing them and figuring out which party member has them can be a challenge. I would have liked the ability to filter out nonmagical items and items the character isn't proficient with when equipping and a search function that covers the entire party inventory and the stash. Also, I never really understood the little bars that tell you how encumbered you are.
