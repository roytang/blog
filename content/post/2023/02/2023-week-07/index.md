...
This past week was exhausting. Lots of going out for me: some bank errands I've long been putting off, the return of quiz nights, movie watchings, meeting up with old friends. Lots of walking too.
...
- **Gaming**: 
    - Single player: Still playing **Witcher 3** (running around searching for treasure, trying to save a bard), but also finished [Ori and the Will of the Wisps](/2023/02/ori2/)!
    - Online: Did some more drafts of [All Will Be One](/tags/mtgone/) on **Magic Arena**. **Eternal**, **Marvel Snap** still ongoing. 

- **Books**: Haven't started any new ones yet.

- **Movies**: Watched [Ant-Man and the Wasp: Quantumania (2023)](https://roytang.net/2023/02/ant-man-and-the-wasp-quantumania-2023/)
...
The first statue I noticed was a small one that I initially thought was a child hiding in the dark among some bushes alone at night maybe waiting for his parents. Kinda creepy!

### Some Links

- [Where the Elements Came From](https://kottke.org/23/02/where-the-elements-came-from): This color-coded periodic table is just a neat reminder that we are all made of star stuff

- [Frank Chimero - There is a Horse in the Apple Store](https://web.archive.org/web/20100909050013/http://blog.frankchimero.com/post/1059696119/there-is-a-horse-in-the-apple-store): > When does the magic of a situation fade? When do we get acclimated to the exceptional?

- [Writing Javascript without a build system](https://jvns.ca/blog/2023/02/16/writing-javascript-without-a-build-system/): In 2015, I came out of a long stint at a company that didn't follow these frontend trends and was baffled at all the JS build systems that seemed wildly unnecessary for most simple sites, yet people were treating them as required frontend material

- [God Did the World a Favor by Destroying Twitter | WIRED](https://www.wired.com/story/god-did-us-a-favor-by-destroying-twitter/): > But when I go back and read Genesis, I hear God saying: “My children, I designed your brains to scale to 150 stable relationships. Anything beyond that is overclocking. You should all try Mastodon.”
