...
I was looking to try out some [Flex][1] stuff at home, but of course I didn't have a personal Flex Builder license I could use. (A coworker of mine wisely advised me not to try using my work license at home.) So I looked around to see if there were any free (as in beer and as in speech) alternatives.

The one I found was [FlashDevelop][2]. Although the IDE looks Eclipse-like, it's actually built using .Net. While it's not yet 100% polished, my impression from about an hour of working with it is that it's reasonably mature and quite fast (speed is not exactly something you could claim was a strength of Adobe Flex Builder.)
