...
<div class="decklist">
  <ul class="decklist_group">
    ...
    <li>
      2 <a href="http://magiccards.info/autocard.php?card=Hostility">Hostility</a>
    </li>
    <li>
      2 <a href="http://magiccards.info/autocard.php?card=Chameleon Colossus">Chameleon Colossus</a>
    </li>
    <li>
      2 <a href="http://magiccards.info/autocard.php?card=Spectral Force">Spectral Force</a>
    </li>
    <li>
      12 <a href="http://magiccards.info/autocard.php?card="></a>
    </li>
    <li>
      4 <a href="http://magiccards.info/autocard.php?card=Skred">Skred</a>
    </li>
    <li>
      4 <a href="http://magiccards.info/autocard.php?card=Incinerate">Incinerate</a>
    </li>
    <li>
      4 <a href="http://magiccards.info/autocard.php?card=Sulfurous Blast">Sulfurous Blast</a>
    </li>
    <li>
      4 <a href="http://magiccards.info/autocard.php?card=Disintegrate">Disintegrate</a>
    </li>
    <li>
      4 <a href="http://magiccards.info/autocard.php?card=Into the North">Into the North</a>
    </li>
    <li>
      4 <a href="http://magiccards.info/autocard.php?card=Harmonize">Harmonize</a>
    </li>
    <li>
      1 <a href="http://magiccards.info/autocard.php?card=Garruk Wildspeaker">Garruk Wildspeaker</a>
    </li>
    <li>
      25 <a href="http://magiccards.info/autocard.php?card="></a>
    </li>
    <li>
      4 <a href="http://magiccards.info/autocard.php?card=Treetop Village">Treetop Village</a>
    </li>
    <li>
      2 <a href="http://magiccards.info/autocard.php?card=Llanowar Wastes">Llanowar Wastes</a>
    </li>
    <li>
      4 <a href="http://magiccards.info/autocard.php?card=Highland Weald">Highland Weald</a>
    </li>
    <li>
      2 <a href="http://magiccards.info/autocard.php?card=Tresserhorn Sinks">Tresserhorn Sinks</a>
    </li>
    <li>
      6 <a href="http://magiccards.info/autocard.php?card=Snow Covered Forest">Snow Covered Forest</a>
    </li>
    <li>
      5 <a href="http://magiccards.info/autocard.php?card=Snow Covered Mountain">Snow Covered Mountain</a>
    </li>
    <li>
      23 <a href="http://magiccards.info/autocard.php?card="></a>
    </li>
  </ul>
  ...
  <ul class="decklist_group">
    ...
    <li>
      4 <a href="http://magiccards.info/autocard.php?card=Cryoclasm">Cryoclasm</a>
    </li>
    <li>
      3 <a href="http://magiccards.info/autocard.php?card=Void">Void</a>
    </li>
    <li>
      3 <a href="http://magiccards.info/autocard.php?card=Extirpate">Extirpate</a>
    </li>
    <li>
      3 <a href="http://magiccards.info/autocard.php?card=Boldwyr Heavyweights">Boldwyr Heavyweights</a>
    </li>
    <li>
      2 <a href="http://magiccards.info/autocard.php?card=Pyroclasm">Pyroclasm</a>
    </li>
  </ul>
