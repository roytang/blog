...
- that $100 annual fee for an Apple Developer account. If you're a 1st world developer, that cost isn't much, but if you're a young hobbyist developer in a poorer country who just wants to try making an app, it can be a significant hurdle. Google also charges you some token amount for Play Store access, but at least it's just a one-time fee. 
