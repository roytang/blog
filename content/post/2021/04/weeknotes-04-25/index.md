...
- An ongoing saga right here in the Philippines: 
    ...
    - Predictably, it didn't take long for the government to butt in, with [the police reportedly investigating the people behind the pantries for communist links](https://twitter.com/roytang/status/1384280033351462912). Some other national government people even said they might require permits. For what, giving food away? 
    ...
    - Some women in Pasig went viral for a bit after they were caught on video raiding a community pantry and getting much more than could be reasonably expected, one of them even carting off a trayful of eggs. They supposedly claimed they were going to give away to their neighbors. They later [apologized](https://www.msn.com/en-ph/entertainment/other/mga-babaeng-nanlimas-sa-community-pantry-sa-pasig-dumepensa-na/ar-BB1fUtan), but supposedly they [were planning to file charges against the person who took a video of them](https://twitter.com/news5ph/status/1384855185932042241). My take: the thing about decentralized movements like this is that they tend to easily self-correct through the vigilance of the participants as seen here. There have been no other reports of similar incidents after this one went viral, so at the very least they served as an example of what not to do.
    - Last Friday, a community pantry started by actress Angel Locsin ended in disaster when an old man died while in the queue. Blowback from the pantry critics and the DDS was fierce. Locsin [quickly issued an apology](https://www.gmanetwork.com/entertainment/showbiznews/news/76345/angel-locsin-issues-apology-after-senior-citizen-dies-in-line-at-her-community-pantry/story) and accepted the blame, drawing contrasts with how the national government never apologizes or admits to mistakes. 
    - Recently, news broke that the National Security Adviser [had imposed a gag order on the notorious NTF-ELCAC spokespersons re: community pantries](https://onenews.ph/gag-order-imposed-on-parlade-badoy). 
    - Probably one of the reasons we can't have nice things: [people can't be generous without some other people becoming suspicious and assigning nefarious motives](https://twitter.com/LaTtEX/status/1384416859701792771). We'll see what happens with these pantries moving forward.
- Speaking of covid, India's experiencing the [worst surge of the pandemic so far](https://www.bbc.com/news/world-asia-india-56798248). Twitter has been [accused of censoring tweets critical of the Indian government's covid response](https://mashable.com/article/twitter-hides-tweets-critical-indian-government-handling-covid/). The US is facing calls to [loosen export bans](https://www.theguardian.com/world/2021/apr/25/us-pressed-to-lift-export-ban-to-help-india-fight-surge-in-covid-cases?CMP=twt_gu#Echobox=1619342451) and [lighten up on vaccine patents](https://www.theguardian.com/commentisfree/2021/apr/24/covid-vaccines-patents-pharmaceutical-companies-secrecy) to help out India (and the rest of us in the global south, really).
- Some lighter news: One year ago in Apr 24 2020, an epic battle among a ton of people named Josh was scheduled a year in advance, to fight for the name. It [happened yesterday](https://twitter.com/gothspiderbitch/status/1386031209457852418)! They had a pool noodle battle and named a 5 year old "King Josh" or some such. Lots of fun!


### Links of interest:

- Messaging app Signal, famous for its encryption protections, raised concerns about vulnerabilities in software often used by authoritarian regimes to bypass the security of such apps: [Exploiting vulnerabilities in Cellebrite UFED and Physical Analyzer from an app's perspective](https://signal.org/blog/cellebrite-vulnerabilities/). The great thing is how the report does a hilarious "wink wink nudge nudge" implying the users of such apps might not want to target Signal in the future.
- Some stuff about blogging and personal websites:
    - [No wrong notes.](https://matthiasott.com/notes/no-wrong-notes)
    - [The conversation has never been wider.](https://kottke.org/21/04/the-conversation-has-never-been-wider)
    - [Why blog? Blogs are great.](https://disquiet.com/2021/04/10/q-why-blog-a-blogs-are-great/). (I mostly disagree with "have a topic focus" though. I'll write what I want to write, damnit!)
- [How fit can you get from just walking?](https://www.gq.com/story/get-fit-from-just-walking) One of the tragedies of the pandemic is that I've had to reduce my general walking output, since I can't just wander around as far as I want anymore.
- [Mads Mikkelsen: "Make everything important."](https://kottke.org/21/04/make-everything-important)
- There's a [page / app you can check](https://blolook.osa-p.net/) to see how many people have blocked you on Twitter.
