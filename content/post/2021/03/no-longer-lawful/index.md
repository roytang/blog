...
The original online alignment quiz is no longer available on the current Wizards/DND site, but there are some that have [replicated it elsehwere](http://easydamus.com/alignmenttest.html). I recently took it again to confirm what I've know for a few years now (image result attached). My current alignment is **Neutral Good**.

[Description of Lawful Good](http://easydamus.com/lawfulgood.html) | [Description of Neutral Good](http://www.easydamus.com/neutralgood.html)

* The DND Alignment system is of course an imperfect and vastly oversimplified method of ascertaining one's personality (after all, very few people would openly accept being called "Evil" on this scale), but I find it can sometimes be helpful as an abstraction of a person's general outlook on life, as long as you know the model's limitations. Individual moments or actions of course, are not obliged to follow one's given alignment, and as it can see here, alignment can easily shift over time. The alignment system is probably roughly as useful as Myers-Briggs.
