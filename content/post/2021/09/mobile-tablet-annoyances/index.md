...
- I've been meaning to construct an experiment to document exactly which apps on each platform have which problems but I'm lazy so I'll just write this blog post without experimental data