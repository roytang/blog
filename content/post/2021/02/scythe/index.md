...
Games tend to go at least an hour long, roughly 20 or so turns in our experience. Because of the game's pacing and action structure, you can have games where it feels like I haven't accomplished much by then. Usually this creates a bit of snowball effect as well - the player who gets his act together earlier will tend to pull ahead and be difficult to catch up to. I'm not sure if there's a [comeback mechanism](https://tvtropes.org/pmwiki/pmwiki.php/Main/ComebackMechanic) we're missing.
