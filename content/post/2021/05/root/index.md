---
date: 2021-05-03 07:19:50
reviews:
- description: A fun competitive multi-faction board game where each faction plays
    differently.
  link: https://store.steampowered.com/app/965580/Root/
  media: games
  rating: 4
  title: Root
syndicated:
...
- gaming
- games
title: 'Digital Boardgames Review: Root'
---

Over the past couple of years, I've been regularly playing digital boardgames online on Steam with one of my friend groups, I thought I'd do reviews of them. This is my fourth such review, and this time I'm gonna talk about [Root](https://store.steampowered.com/app/965580/Root/). This is a IRL boardgame by Leder Games with the Steam version published by Dire Wolf Digital.
...
- The cats (Marquis) faction are the like the dominant empire in the area, and they gain points primarily by establishing more buildings, but among the factions they get the fewest actions per turn. 
- The birds (Eyrie) represent an old empire trying to make a comeback; they score points primarily by establishing roosts but they follow a strict set of decrees that govern what they must do each turn. If they fail to obey the decrees, their government goes into turmoil, loses some points and has to start over with a new leader. 
- The Woodland Alliance represent plucky rebels aiming to establish their own government. They earn points by spreading sympathizers across the map. Whenever other factions attack them or move troops through sympathizer clearings, they earn more supporters, which can be used to establish bases (which let you recruit warriors) and gain even more supporters. 
- Finally, the Vagabond is a freelance adventurer, wandering around the land digging up treasure for ruins and trading for items. He gets stronger the more items he has, can score points by crafting new items, completing quests, or fighting other factions. He can lend his support or even ally with one of the factions for a coalition victory. The Vagabond has several variants that start with different item sets and each have a unique special action.
