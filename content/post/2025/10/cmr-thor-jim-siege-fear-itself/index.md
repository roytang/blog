...
- hashtag: journey-into-mystery-v3-1996
  description: ''
  media: comics
  title: 'Journey Into Mystery v3'
  issues: 20
  year: 1996
- hashtag: thor-v2-1998
  description: ''
  media: comics
  title: 'Thor v2'
  issues: 85
  year: 1998
- hashtag: thor-v3-2007
  description: ''
  media: comics
  title: 'Thor v3'
  issues: 36
  year: 2007
- hashtag: siege-2010
  description: 'Crossover event that ends Dark Reign.'
  media: comics
  title: 'Siege'
  issues: 16
  year: 2010
- hashtag: the-mighty-thor-v1-2011
  description: ''
  media: comics
  title: 'The Mighty Thor v1'
  issues: 35
  year: 2011
- hashtag: journey-into-mystery-v4-2011
  description: ''
  media: comics
  title: 'Journey Into Mystery v4'
  issues: 23
  year: 2011
- hashtag: fear-itself-2011
  description: 'Crossover event with many, many subseries'
  media: comics
  title: 'Fear Itself'
  issues: 73
  year: 2011
- hashtag: thor-v6-2020
  description: ''
  media: comics
  title: 'Thor v6'
  issues: 35
  year: 2020
- hashtag: immortal-thor-v1-2023
  description: ''
  media: comics
  title: 'Immortal Thor v1'
  issues: 25
  year: 2023
tags:
- comics
...
{{% collections-embed comics thor-2007 %}}
...
This continued Fraction's run, and although it overlapped with *Fear Itself* time-wise, only one issue of this volume was actually a tie-in. This run is kind of forgettable, though many of the earlier issues were drawn by excellent Olivier Coipel, so that redeems it a bit.
...
{{% collections-embed comics fear-itself-1 %}}
...
- Fear Itself: Sin's Past (1 issue) - reprint
...
This was the most recent volume of Thor, ending in 2025. It featured fantastic Alex Ross covers and was written by Al Ewing. 

{{% collections-embed comics immortal-thor-covers %}}

It features All-Father Thor going up against an array of elder gods led by Toranos, the "Utgard-Thor", who all predate the Asgardians. A lot of it felt very high-concept, though this is typical of Thor. At some point, through the machinations of the Enchantress, her and Thor's son Magni from the lost Dan Jurgens "Lord of Earth" future timeline was brought into the 616 reality. 

This volume ends in tragedy with the Rainbow Bridge being destroyed and Thor dying as prophesized by Loki. With the Bifrost destroyed and the All-Father lost, Midgard became disconnected from the remaining nine realms and the history of Thor and Asgard on Earth faded from memory and was rewritten, causing Beta Ray Bill to become one of the founding Avengers in Thor's place.

Meanwhile, in the void of nonexistence Vidbláinn, Thor confronts his counterpart Donald Blake, now turned into the Serpent/God of Lies. Thor sacrifices their souls to return one mortal soul to Midgard.

### Wrapping Up

With that, we are caught up with all the mainline Thor books! There is a new *Thor* volume that started a mere two months ago featuring a now-mortal "Sigurd Jarlson" who may or may not be Thor, but it may be a while before I write about that.

It was unexpectedly interesting to follow all the Asgardian side stories via *Journey to Mystery* as well, and there are still a lot of Thor-adjacent books I have yet to read as well that expounds on those stories - notably the *Loki* and *Angela* books during the modern era.

It also kind of feels weird that I have now covered all the mainline Thor and Captain America books, but they are mostly out of order. I kind of want to have a page where I have a chronological list of each major "line" linking to the individual reviews to make them easier to follow?!?

### Progress Bar

Total issues covered in this post: 348. 

Total number of titles/volumes covered in this post: 41 (!!). So so many! I blame *Fear Itself*.

Total issues covered so far: 5,885 + 348 = 6,233

Current total (released) according to [the reference reading order](https://cmro.travis-starnes.com/reading-order.php?page=1&list_type=1&limit=30) as of Oct 27: 36,121 (+450 since the previous post)

Progress: 17.25% (16.5% last post). A decent jump.

More new issues were released during this time than I was able to write about, so I am falling behind a bit. My fault, as it took me so long to get around to writing this!
