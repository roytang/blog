...
This was the first time Marvel had a second solo ongoing series for a character, and was actually the second spin-off Spider-Man series (the first being *Marvel Team-Up*, which always featured Spidey teamed with another Marvel character). It was eventually retitled to the easier *Spectacular Spider-Man* from #134 forward, which I much prefer.
...
{{< collections-embed comics ssm-old-covers >}}
...
{{< collections-embed comics ssm-spot >}}
...
*Spectacular Spider-Man #131–132* (1987)
...
### Spectacular Spider-Man v2 (2003)

- 27 issues (2003-2005)

{{< collections-embed comics ssm-v2 >}}

After that first run, there were only 2 other short SSM runs (and a one-shot), might as well include them here so that all SSM issues are already done.

V2 was an okay run pre-Civil War, most of it written by Paul Jenkins and many of the issues had cartoonish art by Humberto Ramos. Notable storylines: 

- **Spider-Man Disassembled**: SSM v2 #17-20. Spidey faces a villain called "The Queen" who transforms Peter into a monstrous spider, and while he eventually gets his body back, it comes with some changes, such as organic webs! Not sure if they did this to better sync with the Raimi trilogy of films (first film came out in 2002). These changes were presumably reverted after "One More Day".
- **Read 'Em An' Weep**: SSM v2 #21. This was a fun standalone issue where Spidey joins an annual poker game with other superheroes, which is crashed by a surprise participant: Wilson Fisk, the Kingpin of Crime!
- **Sins Remembered**: SSM v2 #23-26. A follow-up to Straczynski's much-maligned "Sins Past" storyline which happened in ASM a bit earlier.

### Spectacular Spider-Man #1000 (2011)

- 1 issue

This was a one-shot where Spidey teams up with Punisher. IDK why they chose to go with this numbering. Currently, the legacy numbering for SSM only goes up to 300+, but this one will give them trouble if it ever gets close to 4 digits.

### Peter Parker: The Spectacular Spider-Man v3 (2017)

- 23 issues: #1-#6, #297-#313
- 1 annual

{{< collections-embed comics ssm-b99 >}}

Most of this run is by Chip Zdarsky and it is excellent. A good chunk of it involves Peter Parker's long-lost sister Teresa and at some point they travel to a parallel timeline and due to their shenanigans the Peter Parker of that universe gives up being Spider-Man early, to disastrous consequences.

Of note: in this volume, Peter finally unmasks before J. Jonah Jameson. He is a bit more accepting this time as compared to the last time he found out Peter's identity in Civil War, and becomes a new, annoying ally for Peter, even as they travel to a different timeline!

Zdarksy's run ends with #310. The last 3 issues are a Spider-Geddon tie-in where Peter faces off against Morlun (again). Morlun fights are always brutal and fun to read though. Because of this tie-in I was tempted to read the rest of the Spider-Geddon stuff and include it in this post, but the post is already way too long, and besides I should probably group all the "Spider-Verse" related storylines together in some future post!

The one annual for this run was also pretty good; main story is by Zdarsky and is focused on Jameson. Of note is that it establishes some signposts for Marvel's "sliding timeline": according to the annual, Peter started as Spider-Man "twelve years ago" and the death of Jean DeWolffe happened "five years ago"!
...
- Issues #14-#18 [Dark Web crossover](/2023/05/marvel-run-4-thor-etc/#dark-web-2023)
- Issues #17 First appearance of Rek-Rap (I like this character he is silly lol)
- Issues #39-#44 Gang War crossover (see below)
- Peter inheriting Norman Osborn's sins and becoming Spider-Goblin

Zeb Wells run ends with #60. 

Issues #61-#70 are by Joe Kelly and part of the "8 Deaths of Spider-Man" story arc where the new Sorcerer Supreme (Doom) tasks Spider-Man with defeating champions of Cyttorak. This was a fun romp which let Spidey become a Juggernaut!
...
*Gang War* was a crossver centered around ASM v7 that involved multiple gangland/mobster/supervillain factions vying for control of the New York City underworld now that Wilson Fisk is out of the picture. The storyline was okay, but my main gripe with it is that after [Chip Zdarsky's Daredevil run and Devil's Reign event](/2023/11/cmr-daredevil/#devils-reign), supposedly Kingpin's son Butch Pharris was the new Kingpin of NYC, and he isn't even mentioned in this event! (I do love that after all my reading I am able to find this sort of nonsense continuity problem!)

### Progress Bar

Total issues covered in this post: 419.

Total number of titles/volumes covered in this post: 10

Total issues covered so far: 5,131 + 419 = 5,550

Current total (released) according to [the reference reading order](https://cmro.travis-starnes.com/reading-order.php?page=1&list_type=1&limit=30): 35,505 (+228 since the previous post)
...
Some notes about my progress on the complete Marvel run:

- So far I have been strictly reading and reviewing comics by title/volume, but that might not work in the case of characters like Spider-Man who for a couple of decades had multiple ongoing titles that regularly crossed over with each other. I am considering shifting to a year-by-year approach for this sort of group of titles. After all, I don't want to cover Maximum Carnage or the 90s Clone Saga again when I go through *Amazing Spider-Man*, then again when I cover *Web of Spider-Man* etc. I need to think about how I am going to index those reviews though, since my current system is still by title.
- Correspondingly, I am considering the "year by year" approach to annuals as well - mostly because Marvel has this habit of having some crossover stories happen across the set of annuals for a year. And it would free me from having to include the annuals when I cover each title. There are much less annuals published than regular titles, so this one is very feasible.
- I'm still not satisfied with the rate at which my completion rate is increasing. At this rate it will take something like 20 more years before I finish the complete marvel run! That isn't really a problem, since I mostly still enjoy reading the comics, but I would still like to hit a faster rate. The main issue is that there are at least an estimated 3000 to 5000 issues that I have already read prior to the 2020s but don't have write-ups for. To at least stop the backlog of newer from growing too quickly, I'm going to try to include more of the newer/current volumes in these posts (which is why I included ASM v7 above). And maybe try to up the frequency of these posts? Not sure if that's feasible - at this point the limiting factor is how fast I can make the write-ups!

### Up Next

Okay, for real, the next entry should be focused on **Captain America** post-Heroes Reborn.
