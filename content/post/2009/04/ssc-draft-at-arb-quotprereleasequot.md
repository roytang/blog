...
--></p> 
  ...
  <div class="decklist">
    <ul class="decklist_group">
      ...
      <li>
        1 <a href="http://magiccards.info/autocard.php?card=Saccellum Archers">Saccellum Archers</a>
      </li>
      <li>
        1 <a href="http://magiccards.info/autocard.php?card=Knotvine Mystic">Knotvine Mystic</a>
      </li>
      <li>
    ...
    <ul class="decklist_group">
      ...
      <li>
        1 <a href="http://magiccards.info/autocard.php?card=Scattershot Archers">Scattershot Archers</a>
      </li>
    </ul>
...
First round I was up against the deck with a lot of rares. I knew he had like [Empyrial Archangel][3], [Sphinx Sovereign][4], [Inkwell Leviathan][5] and [Battlegrace Angel][6], so I just hit him hard and fast before he could play his monsters. I won 2-0.

Second round my opponent was basically color-screwed in both games and was hardly able to put up a fight.
...
Local prereleases are going to push through next weekend, plus release events the weekend after that.
 ...
 [1]: http://magiccards.info/autocard.php?card=Skeletonize
 [2]: http://magiccards.info/autocard.php?card=Executioner's Capsule
 [3]: http://magiccards.info/autocard.php?card=Empyrial Archangel
 [4]: http://magiccards.info/autocard.php?card=Sphinx Sovereign
 [5]: http://magiccards.info/autocard.php?card=Inkwell Leviathan
 [6]: http://magiccards.info/autocard.php?card=Battlegrace Angel