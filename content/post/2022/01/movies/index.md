...
- date: 2020-01-15
  description: I had low expectations, but it was better than I thought it would be.
    Ma would like it!
  media: movies
  rating: 3.5
...
- date: 2020-01-17
  description: The editing and scene transitions were all over the place. A very Michael
    Bay film.
  media: movies
  rating: 3.5
...
- date: 2020-01-19
  description: Really good, but IDK how to begin to describe it. Worth overcoming
    the 1 inch subtitle barrier for.
  media: movies
  rating: 5
  title: Parasite (2019)
- date: 2020-02-04
  description: Very light-hearted and idyllic. At first it felt a bit boring, but
    it had me smiling by the end.
  media: movies
  rating: 5
  title: Kiki's Delivery Service (1989)
- date: 2020-02-07
  description: Sandler gave a good performance, but I struggled to get through the
    early parts of the movies because his character and situation are so unrelatable
    to me personally.
  media: movies
  rating: 4
  title: Uncut Gems (2019)
- date: 2020-02-10
  description: Watched this because a redditor said ROTK robbed it of best picture
    in 2003. This is a great war movie, but he was wrong
  media: movies
  rating: 5
  title: 'Master and Commander: The Far Side of the World (2003)'
- date: 2020-02-11
  description: Best movie about a Nazi ever. Most colorful depiction of Nazi Germany.
    Fantastic movie.
  media: movies
  rating: 5
  title: Jojo Rabbit (2019)
- date: 2020-02-27
  description: An acceptable adaptation of one of my favorite Superman stories. Minus
    points for not including the "House of L" epilogue.
  media: movies
  rating: 4
  title: 'Superman: Red Son (2020)'
- date: 2020-02-27
  description: I watched this because I saw it in a "top inspirational speeches" YT
    video. Pretty good sports movie.
  media: movies
  rating: 4
...
- date: 2020-05-05
  description: Caught this on Cinemax when I went down for lunch. Much too idealistic
    in hindsight, given what happened in New York 3 years after this film released.
  media: movies
  rating: 3
  title: The Siege (1998)
- date: 2020-02-09
  description: A fantastic murder mystery, maybe the best I've ever seen, great performances
    all around.
  media: movies
  rating: 5
