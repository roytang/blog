...
This is a short novella, a bit more than a hundred pages on my Kindle app, so it was a quick read. I first heard about it from other bloggers like [Ana Ulin](https://anaulin.org/blog/book-notes-a-psalm-for-the-wild-built/) and [Winnie Lim](https://winnielim.org/notes/on-a-psalm-for-the-wild-built/), and it sounded good, so I was happy when it was released as a freebie on [the Tor eBook club](https://ebookclub.tor.com/) (which I highly recommend - I got started on some series like the [Stormlight Archive](/tags/stormlight-archive/) via this newsletter!).
