...
author: roy
date: 2019-11-17T09:07:22+08:00
categories:
...
In the end I think we did pull it off and were able to implement and integrate the needed changes well, without any major issues. Given C's challenges with memory management and so on, I was kind of expecting we would encounter memory leaks and such, but it turns out using the STL and Boost largely alleviates that problem.
