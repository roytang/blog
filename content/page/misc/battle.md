...
* Alec Baldwin 
    - Boss Baby -> Steve Buscemi
* Anna Faris
    - May -> Girl Interrupted (via Angela Bettis)
* Anya Taylor-Joy
    - New Mutants -> Elysium (via Alice Braga)
* Arnold 
...
* Jen Lawrence 
    - Winter's Bone -> The Help (via the director) or 3 billboards (via some castmate)
    - No Hard Feelings -> Matthew Broderick
* Jim Carrey 
    - The Majestic -> Matt Damon
* John Cena 
...
* Sean Bean 
    - Silent Hill (2006) -> Radha Mitchel (Man on Fire, Phone Booth, Olympus Has Fallen)
* Sebastian Stan 
    - Fresh (2022) -> Hereditary / Midsommar (via cinematographer)
* Tom Holland 
    - The Devil All The Time -> Sebastian Stan, RPatz
    - Locke -> Tom Hardy, Olivia Colman
* Willem Defoe 
    - The Lighthouse -> Knock at the Cabin (via cinematographer)
    - Inside -> The Vanishing (1988) -> The Vanishing (1993) -> Kiefer Sutherland
* Zoe Saldana 
